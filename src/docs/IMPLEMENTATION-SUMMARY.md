...
**Directory: `PantheonSDR/Properties/PublishProfiles/`**
...
```bash
dotnet publish PantheonSDR/PantheonSDR.csproj -p:PublishProfile=linux-x64 -p:VersionPrefix=0.1.0
```
...
- `PantheonSDR/Properties/PublishProfiles/*.pubxml` (4 files)
...
- `PantheonSDR/Program.cs` (added /api/version endpoint)
